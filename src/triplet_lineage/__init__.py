...
_LAZY_EXPORTS = {
    ...
    "admissible_triplet_error": ("theory", "admissible_triplet_error"),
    "binomial_success_probability": ("theory", "binomial_success_probability"),
    "compute_delta_star": ("theory", "compute_delta_star"),
    "recursive_tmc_bound": ("theory", "recursive_tmc_bound"),
    "sample_complexity_bound": ("theory", "sample_complexity_bound"),
    "single_level_oto_bound": ("theory", "single_level_oto_bound"),
    ...
    "exact_maxcut_partition": ("reconstruction", "exact_maxcut_partition"),
    ...
    "observed_hamming_rate": ("reconstruction", "observed_hamming_rate"),
    "partition_triplets": ("reconstruction", "partition_triplets"),
    "percolation_solve": ("reconstruction", "percolation_solve"),
    "recursive_triplet_maxcut_tree": (
        "reconstruction",
        "recursive_triplet_maxcut_tree",
    ),
    "shared_mutation_solve": ("reconstruction", "shared_mutation_solve"),
    "single_level_maxcut_smj_tree": (
        "reconstruction",
        "single_level_maxcut_smj_tree",
    ),
